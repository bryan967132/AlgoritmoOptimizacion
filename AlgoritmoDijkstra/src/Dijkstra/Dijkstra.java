...
public class Dijkstra {
	...
	int getVolT(String[][] mosIni,String[][] mosFin,int[][] rutas,int[][] crd2,String color) {
		String colorS = "B";
		if(color.equals("B")) colorS = "W";
		String[][] tmpMos = new String[mosIni.length][mosIni[0].length];
		for(int i = 0; i < tmpMos.length; i++) {
	...
	int getMovT(int[][] rutas,String[][] mosIni,String[][] mosFin,String color) {
		int movs = 0;
		String[][] tmpMos = new String[mosIni.length][mosIni[0].length];
		for(int i = 0; i < tmpMos.length; i++) {
			for(int j = 0; j < tmpMos[i].length; j++) {
	...
	int[][] crearCaminos(String[][] mosaico1,int[][] rutas,int[][] crd2,String color){
		...
		int[][] falts = getFalts(mosaico1,rutas,crd2,color,caminos);
	...
	int[][] getFalts(String[][] mosaico1,int[][] rutas,int[][] crd2,String color,int cant) {
	...
	int[][] dscrtRutas(int[][] rutas,int[] punto,int[] falts) {
		for(int x = 0; x < rutas.length; x++) {
			//System.out.println("Si " + rutas[x][0] + "," + rutas[x][0] + " = " + punto[0] + "," + punto[1] + " o " + rutas[x][2] + "," + rutas[x][3] + " = " + falts[0] + "," + falts[1]);
